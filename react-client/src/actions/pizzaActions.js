...
export const getAllPizzas = () => async (dispatch) => {
  ...
  try {
    const res = await axios.get(
      "http://localhost:5555/api/pizzas/getallpizzas"
    );
...
export const getPizzaById = (pizzaid) => async (dispatch) => {
  ...
  try {
    const res = await axios.post(
      "http://localhost:5555/api/pizzas/getpizzabyid",
      { pizzaid }
    );
...
export const addPizza = (pizza) => async (dispatch) => {
  ...
  try {
    const res = await axios.post("http://localhost:5555/api/pizzas/addpizza", {
      pizza,
    });
...
export const editPizza = (editedPizza) => async (dispatch) => {
  ...
  try {
    const res = await axios.post("http://localhost:5555/api/pizzas/editpizza", {
      editedPizza,
    });
...
export const deletePizza = (pizzaid) => async (dispatch) => {
  try {
    const res = await axios.post(
      "http://localhost:5555/api/pizzas/deletepizza",
      {
        pizzaid,
      }
    );
